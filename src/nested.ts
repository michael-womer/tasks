...
export function sumPoints(questions: Question[]): number {
    return questions.reduce((currentTotal:number, question:Question):number => currentTotal+question.points, 0)
}
...
export function sumPublishedPoints(questions: Question[]): number {
    return questions.reduce((currentTotal:number, question:Question):number => currentTotal + (question.published ? question.points : 0 ), 0)
...
export function toCSV(questions: Question[]): string {
    const heading:string = "id,name,options,points,published"

    return heading + 
    questions.map((question:Question):string => "\n" + question.id.toString() + "," +  question.name + "," + question.options.length.toString() + "," + question.points.toString() + "," + question.published.toString())
    .join("");
}
...
export function addNewQuestion(
    ...
    return [... questions.map((question:Question):Question => {return {... question, options:[... question.options]};})
...
export function renameQuestionById(
    ...
    return questions.map((question:Question):Question => {
        return question.id === targetId ? {... question, name:newName, options:[... question.options]} : {... question, options:[... question.options]}
    });
}
...
export function changeQuestionTypeById(
    ...
    return questions.map((question:Question):Question => {
        return question.id === targetId ? {... question, type:newQuestionType, options:(newQuestionType === "multiple_choice_question" ? [... question.options] : [])} : {... question, options:[... question.options]}
    });
}
